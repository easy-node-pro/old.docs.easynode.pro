...
![Our help menu options as of 1/13/2023](/fra_help_options.png)
...
<Tabs items={["Create Validator", "Update Validator Info", "Update Fee", "Update Both!"]} defaultIndex="0">
  <Tab>
...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
  <Tab>
    ```text copy
    bash -x ~/findora-toolbox/src/bin/update_mainnet.sh
    ```

  </Tab>
  <Tab>
    ```text copy 
    bash -x ~/findora-toolbox/src/bin/update_testnet.sh
    ```
  </Tab>
</Tabs>
...
<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
  <Tab>
    ```text copy
    bash -x ~/findora-toolbox/src/bin/safety_clean_mainnet.sh
    ```

  </Tab>
  <Tab>
    ```text copy 
    bash -x ~/findora-toolbox/src/bin/safety_clean_testnet.sh
    ```
  </Tab>
</Tabs>
...
This script will wipe your data and reload a fresh database. This can take some time so there will be missed blocks but it will just clean the database, reload the database and restart your validator without wiping other files.
...
Our fn_update script will pull down and setup your fn application with the latest version online. You can run the update with the following code:

<Tabs items={["mainnet", "testnet"]} defaultIndex="0">
  <Tab>
    ```text copy
    bash -x ~/findora-toolbox/src/bin/fn_update_mainnet.sh
    ```

  </Tab>
  <Tab>
    ```text copy 
    bash -x ~/findora-toolbox/src/bin/fn_update_testnet.sh
    ```
  </Tab>
</Tabs>
