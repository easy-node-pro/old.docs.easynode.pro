...
export const getStaticProps = ({ params }) => {
  return fetch(`https://api.github.com/repos/easy-node-pro/guides`)
    .then((res) => res.json())
    .then((repo) => ({
      props: {
...
- [EasyNode.PRO Discord](https://discord.gg/Rcz5T6D9CV) - We do field questions in our Discord server but we may take our sweet time to respond. Other users may provide assistance if they're available so post in the proper channels!
